...
namespace HotelProject.WebUI.Controllers
{
    public class GuestController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:5045/api/Guest");
        ...
        public async Task<IActionResult> DeleteGuest(int id)
        {
            ...
            var responseMessage = await client.DeleteAsync($"http://localhost:5045/api/Guest/{id}");
        ...
        public async Task<IActionResult> UpdateGuest(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"http://localhost:5045/api/Guest/{id}");
        ...
        public async Task<IActionResult> UpdateGuest(UpdateGuestDto model)
        {
            if (ModelState.IsValid)
            {
                ...
                var responseMessage = await client.PutAsync($"http://localhost:5045/api/Guest/", stringContent);
